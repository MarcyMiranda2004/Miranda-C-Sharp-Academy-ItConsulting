public sealed class Singleton
{
    ...
    // Costruttore privato: impedisce 'new Singleton()' dal esterno
    private Singleton()
    {
...
/* 
sealed: impedisce l’ereditarietà, utile per non consentire sub-classing che possa creare nuove istanze.

_instance: memorizza l’oggetto singleton.

lock (_lock): assicura che solo un thread entri alla volta nella fase di creazione.
 */