namespace Lezione_W4_D2.ConstructorInjection
{
    public interface ConsInjILogger
    {
        void Log(string message);
    }

    public class ConsoleLogger : ConsInjILogger
    {
    ...
    {
        private readonly ConsInjILogger _logger;

        public UserService(ConsInjILogger logger)
        {
            _logger = logger;
        }
